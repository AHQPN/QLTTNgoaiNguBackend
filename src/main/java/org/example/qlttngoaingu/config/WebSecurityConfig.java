...
import org.example.qlttngoaingu.security.jwt.AuthEntryPointJwt;
import org.example.qlttngoaingu.security.jwt.AuthTokenFilter;
import org.example.qlttngoaingu.security.services.UserDetailsServiceImpl;
...
public class WebSecurityConfig {
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setAllowedOrigins(Arrays.asList("http://localhost:3000"
                ...
                ,"https://quan-ly-trung-tam-ngoai-ngu-admin.vercel.app")); // Thêm các domain khác nếu cần
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/courses/**").hasAnyRole("ADMIN", "ACADEMIC_MANAGER")
                        ...
                        .requestMatchers("/courseclasses/**").hasAnyRole("ADMIN", "ACADEMIC_MANAGER")
