...
public class AuthController {
    ...
    @Operation(
        summary = "Đăng nhập",
        description = "Đăng nhập vào hệ thống bằng số điện thoại/email và mật khẩu. Trả về access token và refresh token."
    )
    @ApiResponses(value = {
        @io.swagger.v3.oas.annotations.responses.ApiResponse(
            ...
            content = @Content(
                ...
                examples = @ExampleObject(value = "{\"code\": 1000, \"message\": \"Login Successfully\", \"data\": {\"accessToken\": \"eyJhbGciOi...\", \"refreshToken\": \"uuid-token\", \"role\": \"STUDENT\", \"userId\": 1}}")
            )
        ),
        @io.swagger.v3.oas.annotations.responses.ApiResponse(
            responseCode = "401",
    ...
    @Operation(
        ...
        description = "Đăng ký tài khoản mới cho học viên. Hệ thống sẽ gửi email xác thực đến địa chỉ email đã đăng ký."
    )
    @ApiResponses(value = {
        @io.swagger.v3.oas.annotations.responses.ApiResponse(
            responseCode = "200",
    ...
    @Operation(
        ...
        description = "Sử dụng refresh token để lấy access token mới khi token cũ hết hạn. Refresh token có thể gửi qua cookie hoặc request body."
    )
    @ApiResponses(value = {
        @io.swagger.v3.oas.annotations.responses.ApiResponse(
            responseCode = "200",
    ...
    @Operation(
        ...
        description = "Gửi lại email chứa mã xác thực cho người dùng. Có thể dùng để gửi lại email xác thực tài khoản hoặc reset password."
    )
    @ApiResponses(value = {
        @io.swagger.v3.oas.annotations.responses.ApiResponse(
            responseCode = "200",
    ...
    // ====================== XÁC MINH CODE ======================
    @Operation(
        summary = "Xác thực email/mã xác nhận",
        description = "Xác thực tài khoản qua mã từ email. Trả về trang HTML thông báo kết quả xác thực."
    )
    @ApiResponses(value = {
        @io.swagger.v3.oas.annotations.responses.ApiResponse(
            responseCode = "200",
            description = "Trả về trang HTML thông báo kết quả",
    ...
    @Operation(
        summary = "Đăng xuất",
        description = "Đăng xuất khỏi hệ thống. Refresh token sẽ bị xóa và người dùng phải đăng nhập lại."
    )
    @ApiResponses(value = {
        @io.swagger.v3.oas.annotations.responses.ApiResponse(
            responseCode = "200",
    ...
    @Operation(
        ...
        description = "Gửi yêu cầu đặt lại mật khẩu. Hệ thống sẽ gửi email chứa link đặt lại mật khẩu (có hiệu lực trong 2 phút)."
    )
    @ApiResponses(value = {
        @io.swagger.v3.oas.annotations.responses.ApiResponse(
            responseCode = "200",
    ...
    @Operation(
        ...
        description = "Đặt lại mật khẩu mới bằng mã xác thực từ email. Sau khi đổi mật khẩu thành công, người dùng sẽ bị đăng xuất khỏi tất cả thiết bị."
    )
    @ApiResponses(value = {
        @io.swagger.v3.oas.annotations.responses.ApiResponse(
            responseCode = "200",
        ...
        @io.swagger.v3.oas.annotations.responses.ApiResponse(
            responseCode = "400",
            description = "Mã xác thực không hợp lệ hoặc mật khẩu không khớp"
        ),
        @io.swagger.v3.oas.annotations.responses.ApiResponse(
            responseCode = "410",
    ...
    @Operation(
        ...
        description = "Xác minh mã đặt lại mật khẩu có hợp lệ và chưa hết hạn hay không. Endpoint này là optional, có thể bỏ qua và gọi trực tiếp /reset-password."
    )
    @ApiResponses(value = {
        @io.swagger.v3.oas.annotations.responses.ApiResponse(
            responseCode = "200",
            description = "Mã hợp lệ, trả về email của người dùng"
        ),
        @io.swagger.v3.oas.annotations.responses.ApiResponse(
            responseCode = "400",
    ...
    public ResponseEntity<ApiResponse> verifyResetCode(
        @Parameter(description = "Mã xác thực từ email", required = true)
        @RequestParam String code) {
