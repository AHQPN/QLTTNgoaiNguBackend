...
//                else if (typeId == 2) {
//                    if (promoCourseIds.contains(course.getCourseId()) &&
//                            new HashSet<>(selectedCourseIds).containsAll(promoCourseIds)) {
//                        isApplied = true;
//                    }
//                }
